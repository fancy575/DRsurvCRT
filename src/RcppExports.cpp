...
// frailty_est
Rcpp::List frailty_est(const arma::vec& ftime, const arma::vec& delta, const arma::vec trt, const arma::vec& strata, const double& trt_prob1, const double& trt_prob0, const arma::mat& censor_cov, const arma::mat& surv_cov, const arma::vec& censor_fit1, const arma::vec& censor_fit0, const double& beta_c1, const double& beta_c0, const arma::vec& surv_fit1, const arma::vec& surv_fit0, const double& beta_s1, const double& beta_s0, const arma::vec& e_time, const bool RMST_cal);
RcppExport SEXP _DRsurvCRT_frailty_est(SEXP ftimeSEXP, SEXP deltaSEXP, SEXP trtSEXP, SEXP strataSEXP, SEXP trt_prob1SEXP, SEXP trt_prob0SEXP, SEXP censor_covSEXP, SEXP surv_covSEXP, SEXP censor_fit1SEXP, SEXP censor_fit0SEXP, SEXP beta_c1SEXP, SEXP beta_c0SEXP, SEXP surv_fit1SEXP, SEXP surv_fit0SEXP, SEXP beta_s1SEXP, SEXP beta_s0SEXP, SEXP e_timeSEXP, SEXP RMST_calSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(frailty_est(ftime, delta, trt, strata, trt_prob1, trt_prob0, censor_cov, surv_cov, censor_fit1, censor_fit0, beta_c1, beta_c0, surv_fit1, surv_fit0, beta_s1, beta_s0, e_time, RMST_cal));
    return rcpp_result_gen;
END_RCPP
}
// marginal_est
Rcpp::List marginal_est(const arma::vec& ftime, const arma::vec& delta, const arma::vec trt, const arma::vec& strata, const double& trt_prob1, const double& trt_prob0, const arma::mat& censor_cov, const arma::mat& surv_cov, const arma::vec& censor_fit1, const arma::vec& censor_fit0, const arma::vec& surv_fit1, const arma::vec& surv_fit0, const arma::vec& e_time, const bool RMST_cal);
RcppExport SEXP _DRsurvCRT_marginal_est(SEXP ftimeSEXP, SEXP deltaSEXP, SEXP trtSEXP, SEXP strataSEXP, SEXP trt_prob1SEXP, SEXP trt_prob0SEXP, SEXP censor_covSEXP, SEXP surv_covSEXP, SEXP censor_fit1SEXP, SEXP censor_fit0SEXP, SEXP surv_fit1SEXP, SEXP surv_fit0SEXP, SEXP e_timeSEXP, SEXP RMST_calSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type ftime(ftimeSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::vec& >::type e_time(e_timeSEXP);
    Rcpp::traits::input_parameter< const bool >::type RMST_cal(RMST_calSEXP);
    rcpp_result_gen = Rcpp::wrap(marginal_est(ftime, delta, trt, strata, trt_prob1, trt_prob0, censor_cov, surv_cov, censor_fit1, censor_fit0, surv_fit1, surv_fit0, e_time, RMST_cal));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_DRsurvCRT_frailty_est", (DL_FUNC) &_DRsurvCRT_frailty_est, 18},
    {"_DRsurvCRT_marginal_est", (DL_FUNC) &_DRsurvCRT_marginal_est, 14},
    {NULL, NULL, 0}
};

RcppExport void R_init_DRsurvCRT(DllInfo *dll) {
